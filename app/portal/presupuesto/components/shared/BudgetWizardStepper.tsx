...
interface BudgetWizardStepperProps {
  currentStep: number;
  steps: WizardStep[];
}

/**
 * AFLOW Wizard Stepper Component
 * Matches Ajustes AFLOW design with #244F82 branding
 */
export function BudgetWizardStepper({ currentStep, steps }: BudgetWizardStepperProps) {
